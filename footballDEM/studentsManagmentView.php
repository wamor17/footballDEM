...
<html>
    ...
    <?php
        ...
        $getStudents = "SELECT Alumno.Nombre AS NameAlumno, Apellidos, Edad, NUA, Carrera, Equipo.Nombre AS NameTeam, Posicion, Jugador.Goles_Marcados FROM Alumno INNER JOIN Jugador ON Jugador.ID_Alumno = Alumno.ID_Alumno INNER JOIN Equipo ON Jugador.ID_Equipo = Equipo.ID_Equipo;";
                    ...
                    <div class"row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="txtTeamM" class="form-control"><br>
                            </div>
                        </div>
                    </div>
